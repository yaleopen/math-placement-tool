...
class QuizSubmissionQuestionService extends CanvasAPIBaseService {
    ...
    List<QuizQuestion> listQuizSubmissionQuestions(String submissionId) {
        ...
        log.debug("ACTION=External_API DESCRIPTION=List Quiz Submission Questions REQUEST_URL=${url} HTTP_STATUS=${resp.status} RESP_TIME=${System.currentTimeMillis() - start}")
